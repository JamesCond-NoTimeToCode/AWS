...
7. Difference between EBS(Elastic block storage) and instance store:
...
9. How do you scale EC2 instances:
...
DAY2
12. What is the difference between stop, terminate and reboot in EC2:
...
13. How does EC2 integrate with Auto Scaling and Load Balancer:
...
14. What are placement groups and when should you use them:
...
15. How do you secure and EC2 instance:
...
16. What is EC2 Hibernate State, and how does it work:
...
17. How do you troubleshoot high CPU usage in EC2:
...
19. How do you handle high availability and fault tolerance:
...
20. What is EC2 Spot Fleet, and how is it different from spot instances:
...
21. What is difference between EC2 Auto Scaling and Elastic Load Balancing (ELB):
...
DAY3
22. What happens when an EC2 instance running a web application is stopped and restarted:
...
23. What is EC2’s default tenancy? What is Dedicated Instance vs Dedicated Host:
...
24. How do you encrypt data in EC2:
...
26. Can you change the instance type of a running EC2 instance:
        No, you must stop the instance first, then modify the instance type.
27. What is Amazon EC2 Serial Console:
...
28. What is the difference between Replacing Root Volume and Rebuilding an Instance:
...
30. What are the key features of Amazon S3:
...
31. What are Amazon S3 storage classes:
...
DAY4
32. What is the difference between Object Storage and Block Storage:
...
34. How does S3 achieve high durability:
...
35. How does S3 ensure data security:
...
36. What is the difference between S3 Object ACL and Bucket Policy:
...
37. What is Cross-Origin Resource Sharing (CORS) in S3:
...
45. Can S3 Event Notifications trigger multiple destinations:
       No, one event can have only one destination
46. How can you ensure reliable processing of S3 events:
       Use Amazon SQS to queue events and prevent loss
DAY5
47. How do you handle duplicate event notifications:
...
49. When to Use S3 Access Points vs. IAM Roles/Policies:
...
57. What is Amazon S3 Access Analyzer:
        It identifies misconfigured bucket policies that allow unintended public access
58. What is the difference between ACLs and Security Groups in AWS:
...
59. What is the difference between S3 Bucket Policies and IAM Policies:
        S3 Bucket Policy:
...
60. What is S3 Pre-Signed URL and how does it work:
...
61. How does Amazon S3 handle eventual consistency:
...
DAY6
62. What is the difference between S3 Object Expiration and Lifecycle Policies:
...
65. What is the maximum object size allowed in S3:
         5TB per object
         For objects larger than 5GB, use Multipart Upload for better performance
66. What are the different types of S3 Encryption:
...
67. How does S3 Object Tagging work:
...
71. What are the key benefits of using AWS Lambda:
...
72. What are the supported programming languages in AWS Lambda:
          AWS Lambda supports: Node.js, Python, Java, Go, Ruby, .NET (C#), PowerShell
73. How does AWS Lambda pricing work:
...
74. What is the maximum execution timeout for an AWS Lambda function:
          The maximum execution timeout for AWS Lambda is 15 minutes (900 seconds)
75. What is the maximum memory allocation for a Lambda function:
          Memory allocation ranges from 128MB to 10GB in increments of 1MB
76. How does AWS Lambda scale automatically:
...
DAY7
77. What is an execution environment in AWS Lambda:
...
78. What are cold starts in AWS Lambda? How can you reduce them:
...
80. What triggers can invoke an AWS Lambda function:
...
81. How would you design a highly available and scalable image processing system using AWS Lambda:
...
82. How would you handle large payloads in AWS Lambda:
...
83. How would you optimize the cold start time of a high-traffic AWS Lambda function:
...
84. How do you deploy an AWS Lambda function:
...
85. What are environment variables in AWS Lambda:
...
86. What is AWS Lambda Layers? How do they help:
...
87. How do you monitor AWS Lambda performance:
...
88. How can you optimize the performance of an AWS Lambda function:
...
89. What is AWS Lambda@Edge, and how does it differ from regular Lambda:
...
90. Can AWS Lambda functions run inside a VPC? If so, how do you configure it:
        Yes, configure VPC settings to allow Lambda to access RDS, Redis, or private resources.
91. How do you handle errors in AWS Lambda:
...
DAY8
92. How does AWS Lambda integrate with API Gateway:
...
93. What is the difference between synchronous and asynchronous invocation in AWS Lambda:
...
94. What is the AWS Lambda execution role:
        An IAM role that grants Lambda permissions to access other AWS resources (e.g., S3, DynamoDB)
95. What are provisioned concurrency and reserved concurrency in AWS Lambda:
...
96. How does AWS Lambda handle retries for failed executions:
...
97. How do you debug an AWS Lambda function:
...
98. What is AWS Lambda SnapStart:
...
99. How can you use AWS Step Functions with AWS Lambda:
...
100. What are the limitations of AWS Lambda:
...
101. How can you implement CI/CD for AWS Lambda functions:
...
102. How does AWS Lambda compare to Amazon ECS and AWS Fargate:
...
103. AWS Lambda vs. AWS Step Functions – When should you use each:
...
104. AWS Lambda vs. API Gateway – Are they the same:
...
105. AWS Lambda vs. AWS Batch – What’s the difference:
...
106. AWS Lambda vs. Amazon SQS vs. SNS – How are they related:
...
DAY9
107. AWS Lambda vs. AWS Glue – Which one should you use:
...
108. AWS Lambda vs. EventBridge – How are they different:
...
109. AWS Lambda vs. AWS App Runner – When should you use each:
...
110. AWS Lambda vs. AWS Lightsail – What’s the difference:
...
111. How do you ensure secure API communication between AWS Lambda and third-party APIs:
...
112. How do you prevent AWS Lambda from being overwhelmed by a sudden spike in traffic:
...
113. How would you implement a real-time serverless data pipeline using AWS Lambda:
...
114. How would you debug AWS Lambda failures in a production environment:
...
115. How would you implement blue-green deployment for AWS Lambda:
...
116. How would you integrate AWS Lambda with an RDS database efficiently:
...
DAY10
117. How do you handle a scenario where AWS Lambda needs to process events exactly once:
...
118. How do you ensure AWS Lambda security best practices:
...
119. How can you automate AWS Lambda deployments:
...
120. How do you optimize AWS Lambda cost for a high-volume workload:
...
121. Can AWS Lambda be used for real-time edge computing? If so, how:
...
122. How would you handle Lambda function timeout issues:
...
123. How does AWS Lambda integrate with DynamoDB Streams:
...
124. How does AWS Lambda handle concurrency and scaling:
...
125. How does AWS Lambda integrate with REST APIs:
...
126. How do you implement versioning and rollback strategies for AWS Lambda:
...
127. What are the latency differences between Lambda@Edge and normal AWS Lambda:
...
128. What happens if AWS Lambda exceeds its memory allocation:
...
129. How does AWS Lambda handle retries and failures for synchronous vs. asynchronous invocations:
...
130. How would you optimize AWS Lambda cost for batch processing workloads:
...
131. How does AWS Lambda handle environment variables securely:
